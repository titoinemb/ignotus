...
export const Header: React.FC<Props> = ({json, lang}) => {
  return (
    <header>
      <div className='content'>
        <div className="right">
          <img src="/logo_white.png" alt="logo" className='logo' width="50px" />
          <div className="list">
            <ul>
              <li>
                <div id='linkId' onClick={() => {
                  if (window.location.pathname !== "/") {
                    window.location.href = "/";
                  };
                }}>{json.header.text1}</div>
              </li>
            </ul>
          </div>
        </div>
        <div className="left">
          <div className="list">
            <ul>
              ...
              <li>
                <button id="list" className='linkId' onClick={() => {
                  ...
                  <svg id="list" xmlns="http://www.w3.org/2000/svg" width="21px" height="21px" viewBox="0 0 24 24" fill="none">
                    <path id="list" d="M4 6H20M4 12H20M4 18H20" stroke="#fff" />
                  </svg>
                </button>
              </li>
            </ul>
        ...
        <ul>
          <li>
            <div id='linkId' onClick={() => {
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="#ffff" width="18px" height="18px" viewBox="0 0 32 32" version="1.1">
          ...
          <li>
            <div id='linkId' onClick={() => {
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1"><defs></defs><circle className="cls1" cx="12" cy="7.25" r="5.73" /><path className="cls1" d="M1.5,23.48l.37-2.05A10.3,10.3,0,0,1,12,13h0a10.3,10.3,0,0,1,10.13,8.45l.37,2.05" /></svg>
              {json.header.text4}
            </div>
          </li>
        </ul>
